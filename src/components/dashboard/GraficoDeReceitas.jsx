...
import { mes_receitas } from "../../data/datas";

export default function GraficoDeReceitas() {
    return (
        ...
        >
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 bg-linear-to-r from-slate-400 to-slate-500 rounded-full">
                    ...
                    >
                        ...
                        <defs>
                            <linearGradient id="revenueGradient" x1="0" y1="0" x2="0" y2="1">
                                ...
                                <stop offset="100%" stopColor="#8b56f6" />
                            </linearGradient>
